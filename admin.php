  ...
  <body>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
		...
		<form action="add.php">
       <center><p><input style="clear:both;" type="submit" class="button" value="ADD Product"></p></center></form>
  <form action="remove.php">
       <center><p><input style="clear:both;" type="submit" class="button" value="REMOVE Product"></p></center></form>
